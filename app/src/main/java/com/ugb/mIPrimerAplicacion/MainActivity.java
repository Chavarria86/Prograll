            ...
            public void onClick(View view) {
                try {
                    ...
                    if (cantidadTexto.isEmpty()) {
                        Toast.makeText(MainActivity.this, "⚠ Seleciona un numero", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    Toast.makeText(MainActivity.this, "✅ La Conversión es : " + respuesta, Toast.LENGTH_LONG).show();
